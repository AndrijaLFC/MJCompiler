...
public class ConstVarClassDeclListConstDecl extends ConstVarClassDeclList {

    private ConstVarClassDeclList ConstVarClassDeclList;
    private ConstDecl ConstDecl;

    public ConstVarClassDeclListConstDecl (ConstVarClassDeclList ConstVarClassDeclList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstVarClassDeclListConstDecl(\n");
