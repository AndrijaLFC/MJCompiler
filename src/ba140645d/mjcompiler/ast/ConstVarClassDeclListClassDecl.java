...
public class ConstVarClassDeclListClassDecl extends ConstVarClassDeclList {

    private ConstVarClassDeclList ConstVarClassDeclList;
    private ClassDecl ClassDecl;

    public ConstVarClassDeclListClassDecl (ConstVarClassDeclList ConstVarClassDeclList, ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstVarClassDeclListClassDecl(\n");
