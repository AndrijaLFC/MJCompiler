...
public class AddopTermListDeclared extends AddopTermList {

    private AddopTermList AddopTermList;
    private AddopTerm AddopTerm;

    public AddopTermListDeclared (AddopTermList AddopTermList, AddopTerm AddopTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermListDeclared(\n");
