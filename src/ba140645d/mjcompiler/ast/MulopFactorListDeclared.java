...
public class MulopFactorListDeclared extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private MulopFactor MulopFactor;

    public MulopFactorListDeclared (MulopFactorList MulopFactorList, MulopFactor MulopFactor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulopFactorListDeclared(\n");
